...
"_"+location.pathname,JSON.stringify(b))}catch(c){}},fnStateSaveParams:null,iStateDuration:7200,iDeferLoading:null,iDisplayLength:15,iDisplayStart:0,iTabIndex:0,oClasses:{},oLanguage:{oAria:{sSortAscending:": activate to sort column ascending",sSortDescending:": activate to sort column descending"},oPaginate:{sFirst:"İlk",sLast:"Önceki",sNext:"Sonraki",sPrevious:"Önceki"},sEmptyTable:"Tablo Boş",sInfo:"Toplam _TOTAL_ Veri. Gösterilen _START_ ile _END_ Arası",sInfoEmpty:"Showing 0 to 0 of 0 entries",
sInfoFiltered:"(filtered from _MAX_ total entries)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"İlk _MENU_ Veri",sLoadingRecords:"Yükleniyor...",sProcessing:"İşleniyor...",sSearch:"Arama:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"Hiçbir eşleşen kayıt bulunamadı!"},oSearch:h.extend({},m.models.oSearch),sAjaxDataProp:"data",sAjaxSource:null,sDom:"lfrtip",searchDelay:null,sPaginationType:"simple_numbers",sScrollX:"",sScrollXInner:"",sScrollY:"",sServerMethod:"GET",renderer:null,rowId:"DT_RowId"};
